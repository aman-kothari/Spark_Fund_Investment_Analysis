...
After that give answer to following question:
...
funding types (venture, angel, seed, and private equity) and report the answers
...
occurring.
1. Spark Funds wants to see the top 9 countries which have received the highest total
...
you recommend Spark Funds to invest in?

Also answer the following questions:
Note: In the following questions, all the observations refer to investments of the type FT within
5-15 M USD range and for top 3 english speaking countries.
